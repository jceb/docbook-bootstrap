...
wget -O offo-hyphenation-binary.zip 'http://downloads.sourceforge.net/project/offo/offo-hyphenation/2.2/offo-hyphenation-compiled.zip?r=https%3A%2F%2Fsourceforge.net%2Fprojects%2Foffo%2F&ts=1461219320&use_mirror=netix'
unzip offo-hyphenation-binary.zip
rm offo-hyphenation-binary.zip

# http://saxon.sourceforge.net/
[ -e saxon9 ] && rm -rf saxon9
curl -O 'http://netcologne.dl.sourceforge.net/project/saxon/Saxon-HE/9.7/SaxonHE9-7-0-4J.zip'
mkdir saxon9
cd saxon9
...
# https://code.google.com/archive/p/jing-trang/
...
curl -O 'http://netcologne.dl.sourceforge.net/project/docbook/docbook-xsl/1.79.1/docbook-xsl-1.79.1.zip'
