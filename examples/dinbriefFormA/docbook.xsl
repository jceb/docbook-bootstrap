...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:import href="../..//stylesheets/fo/dinbriefFormA.xsl" />
    ...
    <!-- <xsl:param name="body.margin.top">0.7in</xsl:param> -->
    <xsl:param name="img.src.path">/home/jceb/Documents/Projects/docbook-bootstrap/examples/dinbriefFormA/</xsl:param>
</xsl:stylesheet>
