...
1. Get all the additional software (see section
   <<additional_software,Additional Software Needed>>).  Hopefully,
...
* For AsciiDoc input http://ascidoctor.org[Asciidoctor] is required

IMPORTANT: *You also need to download the software listed in file link:lib/README[].*
